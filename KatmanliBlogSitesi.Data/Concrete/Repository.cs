...
namespace KatmanliBlogSitesi.Data.Concrete
{
    public class Repository<T> : IRepository<T> where T : class, IEntity, new()
    {
        ...
        {
            context = _context;
            dbSet = context.Set<T>(); // boş dbset i context içindeki ilgili classın dbseti için ayarladık.
        }
        ...
        public async Task<T> FirstForDefaultAsync(Expression<Func<T, bool>> expression)
        {
