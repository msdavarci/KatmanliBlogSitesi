...
namespace KatmanliBlogSitesi.Data
{
    public class DatabaseContext : DbContext
    {
        ...
        {
            // aşağıdaki metot uygulama ilk defa çalıştığında veritabanı oluştuktan sonra admin paneli giriş yapabilmek için veritabanındaki users tablosuna 1 tane kayıt ekler.
